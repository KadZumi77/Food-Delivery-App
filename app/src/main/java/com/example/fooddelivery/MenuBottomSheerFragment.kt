...
class MenuBottomSheerFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        menuList = ArrayList()
        menuList.add(PopularModel(R.drawable.pop_menu_burger, "Sandwich", "7$",0, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_sandwich, "Momo", "5$",0, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_momo, "Burger", "9$",0, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_burger, "Sandwich", "7$",0, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_sandwich, "Momo", "9$",0, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_momo, "Burger", "5$",0, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_burger, "Sandwich", "7$",0, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_sandwich, "Momo", "7$",0, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_momo, "Burger", "5$",0, 1))
